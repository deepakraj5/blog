...
if (!profile) {
    ...
    if(profile) {
        ...
        async function getProfile () {
            ...
            let profileRes = await profileMethod('http://40.76.74.157/api/v1/profile', jwt_token)
            ...
            postBlogBtn.addEventListener('click', async (e) => {
                ...
                if(validation) {
                    ...
                    let response = await newPostMethod('http://40.76.74.157/api/v1/newpost', jwt_token, formData)
